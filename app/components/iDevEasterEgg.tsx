    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: '16px', borderRadius: '10px', overflow: 'hidden', border: '2px solid #6d28d9' }}>
          <img
            src={EASTER_EGG_IMAGE_URL}
            alt="iDevotion — Woosa BDO"
